        ...
        <div className='py-20 grid grid-cols-5 gap-5'>
          <div>
            ...
            <div className='relative'>
              <input type="email" placeholder='Enter your email' className='border px-4 py-3 mt-4 rounded-sm w-full' />
              <VscSend className='absolute top-7 right-4 text-2xl cursor-pointer' />
            </div>
          </div>
          <div className='ml-14'>
