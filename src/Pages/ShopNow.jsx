...
import { ProductReducer } from '../Slices/ProductSlices.jsx';
    ...
    <Container className="font-Poppins flex">
      <div className='lg:w-[25%] w-full'>
        ...
        <ul>
          ...
          {category.map((item, index) => (
            <HeaderHover key={index} className="capitalize">{item}</HeaderHover>
          ))}
        </ul>
      ...
      <div className='lg:mt-[151px] lg:w-[75%] w-full'>
        <div className='flex items-center justify-end gap-1 mb-7.5'>
          ...
          <select name="" id="" onChange={(e) => setPage(e.target.value)} className='border-2 border-[#D9D9D9] cursor-pointer rounded-md px-5 py-1 ml-2'>
